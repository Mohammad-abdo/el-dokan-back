...
<body>
    ...
    <?php if(isset($report['sections']['plan'])): ?>
        <?php $pl = $report['sections']['plan']; ?>
        <div class="section">
            <div class="section-header">
                <span class="section-title">Company Plan</span>
                <span class="section-count"><?php echo e($pl['plan']['name_ar'] ?? $pl['plan']['name'] ?? '-'); ?></span>
            </div>
            <div class="section-body">
                <?php if(!empty($pl['plan'])): ?>
                    <table class="kv-table">
                        <tbody>
                        <?php $__currentLoopData = [
                            ...
                            <tr>
                                <td><?php echo e($k); ?></td>
                                <td><?php echo e(isset($v) ? (is_bool($v) ? ($v ? 'Yes' : 'No') : $v) : '-'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
                    ...
                    <?php if(!empty($pl['plan']['features'])): ?>
                        <div style="margin-top:10px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:6px; padding:10px 14px;">
                            ...
                            <div style="font-size:10px; color:#374151;">
                                <?php echo e(Str::limit(json_encode($pl['plan']['features'], JSON_UNESCAPED_UNICODE), 450)); ?>
    ...
    <?php if(isset($report['sections']['companyProducts'])): ?>
        <?php $cpb = $report['sections']['companyProducts']; ?>
        <div class="section">
            <div class="section-header">
                <span class="section-title">Company Products</span>
                <span class="section-count"><?php echo e($cpb['total'] ?? count($cpb['products'] ?? [])); ?> items</span>
            </div>
            <div class="section-body">
                <?php if(!empty($cpb['products'])): ?>
                    <table class="data-table">
                        ...
                        <tbody>
                        <?php $__currentLoopData = ($cpb['products'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(!empty($p['first_image_url'])): ?>
                                        <img class="img-thumb" style="width:34px; height:34px;" src="<?php echo e($p['first_image_url']); ?>" />
                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                                </td>
                                ...
                                <td><span class="badge <?php echo e($stockBadge); ?>"><?php echo e($stock); ?></span></td>
                                <td><?php echo e(isset($p['is_active']) ? ($p['is_active'] ? '&#10003;' : '&times;') : '-'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
